...
public class MultipartRequest {
    ...
    public String multipartRequest(String urlTo, String post, String filepath, String filefield) throws ParseException, IOException {
        ...
        try {
            ...
            LogUtil.basic_e("MultipartRequest", "Multipart Form Upload Error");
            e.printStackTrace();
            return "error";
        }
    }
     ...
     * @param filefield field name(字段名)
     * @return
     * @throws ParseException
     * @throws IOException
     */
    public String multipartRequest(String urlTo, HashMap<String, String> params, String filepath, String filefield) throws ParseException, IOException {
        HttpURLConnection connection = null;
        DataOutputStream outputStream = null;
        InputStream inputStream = null;
